...
public class TerminalOperations {
    public static void main(String[] args) {
        ...
        long count2 = Arrays.asList("Apple", "Orange", "Banana", "Kiwi", "Apple",
                "Cherry", "Mango").stream().filter(str -> str.equals("Apple")).count();
        ...
        List<String> appleList = Arrays.asList("Apple", "Orange", "Banana", "Kiwi", "Apple",
                "Cherry", "Mango").stream()
                .filter(s -> s.equals("Apple")).collect(Collectors.toList());
        ...
        System.out.println("total = " + total); // identity 5 den basliyor hepsinin toplami 5+50 = 55
